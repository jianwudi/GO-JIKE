...
type Data struct {
	...
	Grpccli *Data_GRPCCLI `protobuf:"bytes,1,opt,name=grpccli,proto3" json:"grpccli,omitempty"`
}
...
func (x *Data) GetGrpccli() *Data_GRPCCLI {
	if x != nil {
		return x.Grpccli
	}
	return nil
...
func (x *Data_GRPCCLI) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_GRPCCLI) ProtoMessage() {}

func (x *Data_GRPCCLI) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_GRPCCLI.ProtoReflect.Descriptor instead.
func (*Data_GRPCCLI) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{2, 0}
}

func (x *Data_GRPCCLI) GetNetwork() string {
	if x != nil {
		return x.Network
	}
	return ""
...
func (x *Data_GRPCCLI) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
func (x *Data_GRPCCLI) GetTimeout() *durationpb.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x22, 0xa8, 0x01, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x32, 0x0a, 0x07, 0x67, 0x72, 0x70,
	0x63, 0x63, 0x6c, 0x69, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x6b, 0x72, 0x61,
	0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x2e, 0x47, 0x52, 0x50,
	0x43, 0x43, 0x4c, 0x49, 0x52, 0x07, 0x67, 0x72, 0x70, 0x63, 0x63, 0x6c, 0x69, 0x1a, 0x6c, 0x0a,
	0x07, 0x47, 0x52, 0x50, 0x43, 0x43, 0x4c, 0x49, 0x12, 0x18, 0x0a, 0x07, 0x6e, 0x65, 0x74, 0x77,
	...
	0x6f, 0x6e, 0x52, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x42, 0x1e, 0x5a, 0x1c, 0x72,
...
var file_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Data_GRPCCLI)(nil),        // 5: kratos.api.Data.GRPCCLI
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	5, // 4: kratos.api.Data.grpccli:type_name -> kratos.api.Data.GRPCCLI
	...
	6, // 7: kratos.api.Data.GRPCCLI.timeout:type_name -> google.protobuf.Duration
